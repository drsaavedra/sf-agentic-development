---
name: salesforce-anti-patterns
description: Use when authoring or reviewing any Apex class or trigger — a reference of the most common Salesforce anti-patterns (SOQL/DML in loops, no bulkification, missing FLS/CRUD, logic in trigger body, @future, no assertions, mixed layers) with BAD/GOOD code pairs and concrete fixes.
---
