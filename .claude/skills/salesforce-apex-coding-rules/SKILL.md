---
name: salesforce-apex-coding-rules
description: Use when writing or reviewing any Apex class, trigger, or test (.cls, .trigger) — Salesforce coding standards covering layering and structure, security and sharing, bulkification, async patterns, error handling, null safety, naming conventions, and test rules.
---
