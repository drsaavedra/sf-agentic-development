<!--
  SALESFORCE PROJECT TEMPLATE — Claude baseline
  Maintain alongside: .github/copilot-instructions.md

  Twin pairs — edit both sides together to avoid drift:
    .github/copilot-instructions.md                                          ↔  CLAUDE.md
    .github/instructions/salesforce-apex-coding-rules.instructions.md       ↔  .claude/skills/salesforce-apex-coding-rules/SKILL.md
    .github/instructions/salesforce-lwc-coding-rules.instructions.md        ↔  .claude/skills/salesforce-lwc-coding-rules/SKILL.md
    .github/instructions/salesforce-anti-patterns.instructions.md           ↔  .claude/skills/salesforce-anti-patterns/SKILL.md
    .github/instructions/salesforce-commerce-domain-rules.instructions.md   ↔  .claude/skills/salesforce-commerce-domain-rules/SKILL.md
    .github/instructions/salesforce-deployment-rules.instructions.md        ↔  .claude/skills/salesforce-deployment-rules/SKILL.md
    .github/agents/functional-consultant.md                                  ↔  .claude/agents/functional-consultant.md
    .github/agents/qa-engineer.md                                            ↔  .claude/agents/qa-engineer.md
    .github/agents/salesforce-developer.md                                   ↔  .claude/agents/salesforce-developer.md
    .github/agents/architect.md                                              ↔  .claude/agents/solution-architect.md
-->
...
|---|---|
| Writing / reviewing Apex classes, triggers, services | `salesforce-apex-coding-rules` · `generating-apex` |
| Writing Apex test classes | `salesforce-apex-coding-rules` · `salesforce-anti-patterns` · `generating-apex-test` |
| Running Apex tests / coverage | `running-apex-tests` |
| Debugging Apex logs | `debugging-apex-logs` |
| Creating / editing LWC components | `salesforce-lwc-coding-rules` · `generating-lwc-components` |
...
| Reviewing Apex for anti-patterns | `salesforce-anti-patterns` |

Skills whose names begin with `salesforce-` are **authored skills** in `.claude/skills/` in this
repo. All other skills are from `forcedotcom/sf-skills` (install: `npx skills add forcedotcom/sf-skills`).
